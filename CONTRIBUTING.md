...
issue](https://github.com/cisagov/davidh_4-repo/issues) in
...
request](https://github.com/cisagov/davidh_4-repo/pulls),
...
```console
cd davidh_4-repo
pyenv virtualenv <python_version_to_use> davidh_4-repo
pyenv local davidh_4-repo
